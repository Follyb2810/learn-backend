...
const getEmployees =(req, res) =>{
    ...
    if(!employee) {
        return res.status(400).json({'message':`employee with ${req.params.id} not found`})
    }
    res.json(employee)
}
module.exports={getAllEmployees,updateEmployees,deleteEmployees,getEmployees,createNewEmployees}